...
from shapelet_extraction.brute_force import find_shapelets_bf, check_candidate
from shapelet_extraction.fast_shapelets import find_shapelets_fast
from shapelet_extraction.genetic import find_shapelets_gen
from shapelet_extraction.particle_swarm import find_shapelets_pso
from shapelet_extraction.ps_ea import find_shapelets_ps_ea
from visualization.shapelet_tree import ShapeletTree
from util.util import subsequence_dist
...
def extract_shapelet(timeseries, labels, min_len=50, max_len=50, verbose=1):
    ...
    """
    return find_shapelets_fast(timeseries, labels, max_len=max_len, min_len=min_len,
                              verbose=verbose)
